        ...
        <Questions>
          <ShadowBox>
            ...
            <P>
              ...
              needed based on the target allocation you’ve set and your
              available cash.{' '}
              <A
          ...
          <ShadowBox>
            ...
            <P>
              Passiv is for individuals who prefer to manage their own
              retirement portfolio and are tired of losing money to high
              management fees. It’s for anyone who wants to automate the tedious
              parts of portfolio management, like allocating new cash and
              rebalancing.
            </P>
          </ShadowBox>
          <ShadowBox>
            ...
            <P>
              ...
              aiming to partner with brokerages south of the border in 2019 -
              stay tuned (and tell your brokerage about us!).
            </P>
          </ShadowBox>
          <ShadowBox>
            ...
            <P>
              ...
              link your account to Passiv, Passiv sends you over to Questrade’s
              website, where you log in. That tells Questrade to give Passiv
              something called a token. Passiv gets the information it needs
              through this token. To read more about this process, click{' '}
              <A
          ...
          <ShadowBox>
            ...
            <P>
              ...
              official partner and we use Questrade’s official API for
          ...
          <ShadowBox>
            ...
            <P>
              ...
              feature, where Passiv executes trades on your behalf with the
              click of one button. If you do not want to use this feature,
              simply go to Settings and click the Re-authorize button next to
              Read-Only Access. This removes trading access.
            </P>
          </ShadowBox>
          <ShadowBox>
            <H3>
              Is it possible to use the other Elite features without giving
              Passiv trade access?
            </H3>
            <P>
          ...
          <ShadowBox>
            ...
            <P>
              No, you must know which equities you’d like to hold and your
              target allocation for each. Passiv is not qualified to give
              investment advice.
            </P>
          </ShadowBox>
          <ShadowBox>
