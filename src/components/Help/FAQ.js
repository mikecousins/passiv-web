	      	...
	      	<ShadowBox>
	        	<H3>What is Passiv?</H3>
					...
					<ShadowBox>
						...
						<P>Right now we only support Canadian Questrade accounts, but we’re aiming to partner with brokerages south of the border in 2019 - stay tuned (and tell your brokerage about us!).</P>
					</ShadowBox>
					<ShadowBox>
					...
					<ShadowBox>
						...
						<P>Using Passiv will not void Questrade’s terms of service. We are an official partner and we use Questrade’s official API for third-party product integration.</P>
					</ShadowBox>
					<ShadowBox>
					...
					<ShadowBox>
						<H3>Is it possible to use the other Elite features without giving Passiv trade access?</H3>
