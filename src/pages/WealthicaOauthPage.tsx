  ...
  if (error) {
    switch (error.code) {
      ...
      case '0000':
        errorDisplay = (
          <P>
            No access code was provided by Wealthica. Did you approve the
            connection request?
          </P>
        );
        break;
  ...
  return (
    <ShadowBox background="#04a287">
      ...
      {loading ? (
        <React.Fragment>
          <Step>
            Establishing connection to Wealthica...{' '}
...
export default WealthicaOauthPage;
