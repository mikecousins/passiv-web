  ...
  <React.Fragment>
    ...
    <ul>
      <li>
        ...
        (information or software) on Passiv Inc’s web site for personal,
      ...
      <li>
        ...
        restrictions and may be terminated by Passiv Inc at any time. Upon
    ...
    <p>
      The materials on Passiv Inc’s web site are provided “as is”. Passiv Inc
      ...
      of rights. Further, Passiv Inc does not warrant or make any
    ...
    <p>
      In no event shall Passiv Inc or its suppliers be liable for any damages
      ...
      materials on Passiv Inc’s Internet site, even if Passiv Inc or a Passiv
      Inc authorized representative has been notified orally or in writing of
    ...
    <p>
      The materials appearing on Passiv Inc’s web site could include technical,
      typographical, or photographic errors. Passiv Inc does not warrant that
      any of the materials on its web site are accurate, complete, or current.
      Passiv Inc may make changes to the materials contained on its web site at
      any time without notice. Passiv Inc does not, however, make any commitment
      to update the materials.
    </p>

    <h2 id="6-links">6. Links</h2>
    <p>
      Passiv Inc has not reviewed all of the sites linked to its Internet web
      site and is not responsible for the contents of any such linked site. The
      inclusion of any link does not imply endorsement by Passiv Inc of the
      site. Use of any such linked web site is at the user’s own risk.
    </p>

    <h2 id="7-site-terms-of-use-modifications">
      7. Site Terms of Use Modifications
    </h2>
    <p>
      Passiv Inc may revise these terms of use for its web site at any time
    ...
    <p>
      Any claim relating to Passiv Inc’s web site shall be governed by the laws
      of the Province of New Brunswick, Canada without regard to its conflict of
      law provisions.
    </p>
